...
const WeightCalories = () => {
  ...
  const [val2, setVal2] = useState("50 lb")
  ...
  return (
    ...
    <>
       <div style = {{ marginLeft:"25%", marginTop:"-250px",width:"1000px",height:"1600PX"}} className="middle__right">
               <div  className="heading">
                    <p style={{marginLeft:"20px", fontSize:"15px"}}>I plan to lose 5 lb in 30 days by eating less than <span style ={{color:"green", fontSize:"25px" }}>1,155 cals</span> daily.</p>
               </div>

               <div style = {{marginTop:"60px", marginLeft:"-478px"}} className="middle__right__left">
             ...
             <div style = {{ alignItems:"center", justifyContent:"center"}} className="left__five">
