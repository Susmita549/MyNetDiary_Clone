      ...
      >
        <Flex justifyContent={'space-between'}>
          <Box mr={'1.5rem'}>
            <Box mb={'3.5rem'}>
              <Link to="/">
                <Image src={footerItem.logo} h={'68px'} />
              </Link>
            </Box>
            <Flex gap={4}>
            ...
            <Flex color={'#5b6067'} mt="1rem" gap={1}>
              {footerItem.stars.map(star => (
                <Image key={uuidv4()} src={star} width="24px" h={'24px'} />
              ))}
            ...
            <UnorderedList listStyleType={'none'} ml="0">
              <Flex m="45px 0 10px" alignItems={'center'} gap={2}>
          ...
          <Box>
            <Grid templateColumns="repeat(4, auto)" gap={5}>
        ...
        <Box>
          <Box maxW={'1470px'} m="auto" p="0 15px">
            <Flex
              ...
              fontSize={'lg'}
            >
              <Flex gap={2} color="#46618a">
                <Text>Copyright © 2022 MyNetDiary Inc.</Text>
                <Text>All rights reserved.</Text>
              </Flex>

              <Flex alignItems={'center'} color="#46618a">
                <Text
                  p="0 15px"
                  _hover={{
